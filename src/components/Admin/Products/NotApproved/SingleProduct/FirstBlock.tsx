...
import ProductQuantity from "@/components/Admin/Products/NotApproved/SingleProduct/ProductQuantity";
import Reviews from "@/components/Admin/Products/NotApproved/SingleProduct/ReviewsAdmin"; // Adjust the import path as needed
